(function(){
  ...
  const start=function(){
    ...
    addRecent();
    window.addEventListener('load',function(){send('view',null);injectHubNav();injectQrHistory();injectQuery()});
